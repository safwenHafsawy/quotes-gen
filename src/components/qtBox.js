...
class QtBox extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            qtNum : quotes.length,
        ...
        return (
            <div className = "container">
                <div className='row'>
                    ...
                    <div id="quote-box" className="col-sm-10">
                        <div className='row'>
                            ...
                            <div className="col-sm-8">
                                ...
                                <div className='row'>
                                    ...
                                    <div className="col-sm-2">
                                        <button id = 'tweet-quote' className='btn btn-default'><a href="twitter.com/intent/tweet" target="_blank">Share</a></button>
                                    </div>
                                    <div className="col-sm-2">
                                        <button id='new-quote' className='btn btn-default' onClick={this.generateClick}>Refresh</button>
                                    </div>
                                    <div className="col-sm-4"></div>
                                </div>
                            </div>
